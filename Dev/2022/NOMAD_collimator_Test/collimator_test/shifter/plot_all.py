...
for i in range(6):
    ...
    file_in = open("coll_test_wo_coll_van_" + str(i + 1) + ".out", "r")
    lines = file_in.readlines()
    for line in lines:
        if line and "NAN" not in line and "INF" not in line:
            x_van.append(float(line.split()[0]))
            y_van.append(float(line.split()[1]))
    file_in.close()
    ...
    axs[1, 1].plot(x_van, y_van, label="w/o collimator => Van - MT")
    ...
    file_in = open("coll_test_w_coll_van_" + str(i + 1) + ".out", "r")
    lines = file_in.readlines()
    for line in lines:
        if line and "NAN" not in line and "INF" not in line:
            x_van.append(float(line.split()[0]))
    ...
    axs[1, 1].plot(x_van, y_van, label="w/ collimator => Van - MT")
    ...
    if i == 0:
        ...
        axs1[0].set_ylim([-0.1, 35.])
        axs1[1].set_ylim([-0.1, 35.])
    if i == 1:
        axs[0, 0].set_ylim([0., 45])
        axs[0, 0].set_xlim([1.225, 1.325])
        axs[0, 1].set_xlim([0.5, 2.])
        axs[0, 1].set_ylim([0.075, 0.4])
        axs1[0].set_xlim([1., 1.325])
        axs1[1].set_xlim([1., 1.325])
        axs1[0].set_ylim([0., 45.])
        axs1[1].set_ylim([0., 45.])
    if 2 <= i <= 3 or i == 5:
        axs[0, 0].set_xlim([1.9, 2.3])
        ...
        axs1[0].set_xlim([1., 2.5])
        axs1[1].set_xlim([1., 2.5])
        axs1[0].set_ylim([-0.1, 12.])
        axs1[1].set_ylim([-0.1, 12.])
    if i == 4:
        axs[0, 0].set_xlim([1.9, 2.3])
        axs[0, 0].set_ylim([-0.1, 17.])
        axs[0, 1].set_ylim([-0.1, 0.3])
        axs1[0].set_xlim([1., 2.5])
        axs1[1].set_xlim([1., 2.5])
        axs1[0].set_ylim([-0.1, 17.])
        axs1[1].set_ylim([-0.1, 17.])
