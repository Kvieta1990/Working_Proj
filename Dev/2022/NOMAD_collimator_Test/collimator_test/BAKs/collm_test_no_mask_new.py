...
# Sample - diamond
sfilename_noc = '/SNS/NOM/IPTS-28922/nexus/NOM_171381.nxs.h5'
samplename_noc = 'Dia_wo_coll'

# Empty Can
mfilename_noc = '/SNS/NOM/IPTS-28922/nexus/NOM_168011.nxs.h5'
mtname_noc = 'MTC_wo_coll'

# Vrod
vrodfilename_noc = '/SNS/NOM/IPTS-28922/nexus/NOM_168012.nxs.h5'
vrodname_noc = 'Vrod_wo_coll'

# Cal
calfile_noc = '/SNS/NOM/shared/CALIBRATION/Collimator_Test/NOMAD_171381_2022-03-03_shifter.h5'

# -------------- w/ collimator --------------

# Sample - diamond
sfilename_c = '/SNS/NOM/IPTS-30147/nexus/NOM_183699.nxs.h5'
samplename_c = 'Dia_w_coll'

# Empty Can
mfilename_c = '/SNS/NOM/IPTS-30147/nexus/NOM_183701.nxs.h5'
mtname_c = 'MTC_w_coll'

# Vrod
vrodfilename_c = '/SNS/NOM/IPTS-30147/nexus/NOM_183700.nxs.h5'
vrodname_c = 'Vrod_w_coll'

# Cal
calfile_c = '/SNS/NOM/shared/CALIBRATION/Collimator_Test/NOMAD_183699_2022-08-05_shifter.h5'
...
mask_det = mask_det_ids[5]
fig, axs = plt.subplots(2, 2, figsize=(18, 11))

for ax in axs.flat:
    ax.set(xlabel='d-spacing (angstrom)', ylabel='Int. (a. u.)')
...
axs[0, 0].plot(x_val, y_sample_norm, label="w/o collimator - Dia_w_bkg => norm")
axs[0, 0].plot(x_val, y_mtc_norm, label="w/o collimator - bkg_norm")
axs[1, 0].plot(x_val, y_sample_m_mtc_norm, label="w/o collimator - Dia_wo_bkg => norm")
axs[0, 1].plot(x_val, y_sample_norm, label="w/o collimator - Dia_w_bkg => norm")
axs[0, 1].plot(x_val, y_mtc_norm, label="w/o collimator - bkg_norm")
axs[1, 1].plot(x_val, y_sample_m_mtc_norm, label="w/o collimator - Dia_wo_bkg => norm")
...
axs[0, 0].plot(x_val, y_sample_norm, label="w/ collimator - Dia_w_bkg => norm")
axs[0, 0].plot(x_val, y_mtc_norm, label="w/ collimator - bkg_norm")
axs[1, 0].plot(x_val, y_sample_m_mtc_norm, label="w/ collimator - Dia_wo_bkg => norm")
axs[0, 1].plot(x_val, y_sample_norm, label="w/ collimator - Dia_w_bkg => norm")
axs[0, 1].plot(x_val, y_mtc_norm, label="w/ collimator - bkg_norm")
axs[1, 1].plot(x_val, y_sample_m_mtc_norm, label="w/ collimator - Dia_wo_bkg => norm")
