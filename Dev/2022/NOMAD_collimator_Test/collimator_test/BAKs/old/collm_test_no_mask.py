...
ep_to_compare_str = "38-51, 52-57, 8, 14, 27, 37"
ep_tp_compare = []
...
ep_tp_compare.append([27, 37])

# -------------- w/o collimator --------------

# Sample
sfilename_noc = '/SNS/NOM/IPTS-28922/nexus/NOM_168014.nxs.h5'
samplename_noc = 'Si_wo_coll'
...
# Sample
sfilename_c = '/SNS/NOM/IPTS-30147/nexus/NOM_183703.nxs.h5'
samplename_c = 'Si_w_coll'
...
mask_det = mask_det_ids[2]
fig, axs = plt.subplots(2, 2, figsize=(18, 13))

axs[0, 0].set_title('w/o collimator')
axs[0, 1].set_title('w/ collimator')
axs[1, 0].set_title('w/o collimator')
axs[1, 1].set_title('w/ collimator')
...
axs[0, 0].plot(x_val, y_sample_norm, label="Si_w_bkg => norm")
axs[0, 0].plot(x_val, y_mtc_norm, label="bkg_norm")
axs[1, 0].plot(x_val, y_sample_m_mtc_norm, label="Si_wo_bkg => norm")
...
axs[0, 1].plot(x_val, y_sample_norm, label="Si_w_bkg => norm")
axs[0, 1].plot(x_val, y_mtc_norm, label="bkg_norm")
axs[1, 1].plot(x_val, y_sample_m_mtc_norm, label="Si_wo_bkg => norm")
